...
const Footer: React.FC = () => {
  return (
    <footer >
      ...
      <a href='https://www.nwtrpa.org/' target='_blank'><img src="/assets/sponsors/NWTRPA-Logo.png" alt="Parks and Recreation Logo" style={{ maxWidth: '300px', height: 'auto' }} /></a>
      <br />

      <a href='https://www.nwtrpa.org/activate-nt' target='_blank'><img src="/assets/sponsors/activateNT-logo.jpg" alt="ActivateNT Logo" style={{ maxWidth: '200px', height: 'auto' }} /></a>
