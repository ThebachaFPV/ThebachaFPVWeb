  ...
  return (
    <div style={{ padding: '2rem', color: 'var(--white)', maxWidth: 900, margin: '0 auto' }}>
      ...
      <section style={{ margin: '2.5rem 0', textAlign: 'left' }}>
        <h2>Resources</h2>
        <ul>
          <li><a href="https://github.com/thebachafpv/ThebachaFPVWeb/blob/main/regs/Canada_Basic_Pilot_Certificate_Requirements.md" target="_blank" rel="noopener noreferrer">Basic Pilot Certificate Requirements</a></li>
          <li><a href="https://github.com/thebachafpv/ThebachaFPVWeb/blob/main/regs/Canada_Sub250g_Drone_Laws.md" target="_blank" rel="noopener noreferrer">Sub-250g Drone Laws</a></li>
          <li><a href="https://github.com/thebachafpv/ThebachaFPVWeb/blob/main/regs/Canada_Sub250g_Indoor_Drone_Laws.md" target="_blank" rel="noopener noreferrer">Indoor Drone Laws</a></li>
          <li><a href="https://github.com/thebachafpv/ThebachaFPVWeb/blob/main/regs/Canada_Drone_250g_to_1kg_Private_Property.md" target="_blank" rel="noopener noreferrer">250g-1kg Drones on Private Property</a></li>
